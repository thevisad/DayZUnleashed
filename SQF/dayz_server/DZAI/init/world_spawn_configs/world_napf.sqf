...
diag_log (format["[DZAI] Napf DZAI_staticAI: %1", DZAI_staticAI]);
diag_log (format["[DZAI] Napf DZAI_modName: %1", DZAI_modName]);
if (DZAI_staticAI) then {
	if (DZAI_modName == "unleashed") then {
		diag_log ("[DZAI] Napf Unleashed configuration loading.");
		...
		_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [8,24,850,thisTrigger,[],3,1] call DZAI_spawnBandits_init;", "nul = [thisTrigger] spawn fnc_despawnBandits;"];
		_trigger_6 = _this;
		...
		_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [3,8,350,thisTrigger,[],3,1] call DZAI_spawnBandits_init;", "nul = [thisTrigger] spawn fnc_despawnBandits;"];
		_trigger_9 = _this;
		...
		_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,250,thisTrigger,[],1,1] call DZAI_spawnBandits_init;", "nul = [thisTrigger] spawn fnc_despawnBandits;"];
		_trigger_160 = _this;
		diag_log ("[DZAI] Napf Unleashed configuration finished loading.");
	} else {
		...
		//Auto Generated
		diag_log ("[DZAI] Napf static configuration loading.");
		...
		diag_log ("[DZAI] Napf static configuration finished loading.");
	};
};
