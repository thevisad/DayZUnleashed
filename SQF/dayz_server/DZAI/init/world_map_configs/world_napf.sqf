...
if (DZAI_staticAI) then {
	...
	_this = createTrigger ["EmptyDetector", [16006.47, 19155.197]];
	_this setTriggerArea [800, 800, 0, false];
	_this setTriggerActivation ["ANY", "PRESENT", false];
	_this setTriggerTimeout [20, 25, 30, false];
	_this setTriggerText "suhrenfeld_north";
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,5,650,thisTrigger,[],3,1] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;""]"];
	_trigger_0 = _this;

	_this = createTrigger ["EmptyDetector", [16882.127, 17952.57]];
	_this setTriggerArea [800, 800, 0, false];
	_this setTriggerActivation ["ANY", "PRESENT", false];
	_this setTriggerTimeout [20, 25, 30, false];
	_this setTriggerText "suhrenfeld_south";
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,5,650,thisTrigger,[],3,1] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;""]"];
	_trigger_2 = _this;

	_this = createTrigger ["EmptyDetector", [16508.609, 18400.539]];
	_this setTriggerArea [300, 300, 0, false];
	_this setTriggerActivation ["ANY", "PRESENT", false];
	_this setTriggerTimeout [20, 25, 30, false];
	_this setTriggerText "suhrenfeld_compound";
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,5,300,thisTrigger,[],3,2] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;""]"];
	_trigger_4 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,8,150,thisTrigger,[],3,1] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;""]"];
	_trigger_6 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,2,250,thisTrigger,[],3,1] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;""]"];
	_trigger_9 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,2,250,thisTrigger,[],0,1] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;""]"];
	_trigger_12 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,2,350,thisTrigger,[],0,1] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;""]"];
	_trigger_29 = _this;
	...
	_this setTriggerActivation ["ANY", "PRESENT", false];
	_this setTriggerTimeout [20, 25, 30, false];
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,2,450,thisTrigger,[],0,1] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;""]"];
	_trigger_72 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,2,150,thisTrigger,[],0,1] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;""]"];
	_trigger_150 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "0 = [0,2,550,thisTrigger,[],0,1] call fnc_spawnBandits;", "0 = [thisTrigger] spawn fnc_despawnBandits;""]"];
	_trigger_154 = _this;
