...
/*
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,4,650,thisTrigger,[],3,2] call fnc_spawnBandits;", "nul = [thisTrigger] spawn fnc_despawnBandits;"];
	_trigger_0 = _this;
	...
	_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,5,300,thisTrigger,[],3,2] call fnc_spawnBandits;", "nul = [thisTrigger] spawn fnc_despawnBandits;"];
	_trigger_4 = _this;
*/
