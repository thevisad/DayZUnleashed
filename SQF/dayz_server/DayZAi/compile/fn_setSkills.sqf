...
/*
	...
	Last updated: 7:00 PM 6/14/2013
*/
...
switch (_weapongrade) do {
	case 0: {
		...
		_unit setSkill ["aimingShake",(0.20 + random 0.10)];
		_unit setSkill ["aimingSpeed",(0.50 + random 0.10)];
		...
		_unit setSkill ["commanding",(0.50 + random 0.20)];
		_unit setSkill ["general",(0.40 + random 0.20)];
	};
	case 1: {
		_unit setSkill ["aimingAccuracy",(0.15 + random 0.10)];
		_unit setSkill ["aimingShake",(0.30 + random 0.10)];
		_unit setSkill ["aimingSpeed",(0.60 + random 0.10)];
		_unit setSkill ["endurance",(0.50 + random 0.20)];
		_unit setSkill ["spotDistance",(0.30 + random 0.20)];
		_unit setSkill ["spotTime",(0.30 + random 0.20)];
		_unit setSkill ["courage",(0.50 + random 0.20)];
		_unit setSkill ["reloadSpeed",(0.50 + random 0.20)];
		_unit setSkill ["commanding",(0.60 + random 0.20)];
		_unit setSkill ["general",(0.50 + random 0.20)];
	};
	case 2: {
	...
	case 3: {
		_unit setSkill ["aimingAccuracy",(0.40 + random 0.10)];
