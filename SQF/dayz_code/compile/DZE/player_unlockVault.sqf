...
if(_playerNear) exitWith { CodeInProgress = false; cutText ["Cannot unlock while another player is nearby." , "PLAIN DOWN"];  };
...
if (_alreadyPacking == 1) exitWith {CodeInProgress = false; cutText [format["That %1 is already being unlocked.",_text] , "PLAIN DOWN"]};
