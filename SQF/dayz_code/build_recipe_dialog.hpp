...
class Build_Recipe_Dialog
{
    ...
    class Controls
    {
        ...
        {
            idc = 1201;
            //text = "\z\addons\dayz_code\buildRecipeBook\images\tanktrap.paa"
        ...
        {
            idc = 1202;
            //text = "\z\addons\dayz_code\buildRecipeBook\images\wirefencekit.paa";
        ...
        {
            idc = 1203;
            //text = "\z\addons\dayz_code\buildRecipeBook\images\sandbag.paa";
        ...
        class LogImage: RscPicture
        {
            ...
            //text = "\z\addons\dayz_code\buildRecipeBook\images\wood.paa";
            x = 0.313086 * safezoneW + safezoneX;
        ...
        class ScrapImage: RscPicture
        {
            ...
            //text = "\z\addons\dayz_code\buildRecipeBook\images\scrapmetal.paa";
            x = 0.313086 * safezoneW + safezoneX;
        ...
        class GrenadeImage: RscPicture
        {
            ...
            //text = "\z\addons\dayz_code\buildRecipeBook\images\grenade.paa";
            x = 0.313086 * safezoneW + safezoneX;
        ...
        class ToolboxImage: RscPicture
        {
            ...
            //text = "\z\addons\dayz_code\buildRecipeBook\images\toolbox.paa";
        ...
        class EToolImage: RscPicture
        {
           ...
           // text = "\z\addons\dayz_code\buildRecipeBook\images\etool.paa";
            x = 0.409766 * safezoneW + safezoneX;
