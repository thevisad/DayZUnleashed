...
[] spawn
{
	...
	call compile preprocessFile format ["z\addons\dayz_code\R3F_ARTY_AND_LOG\%1_strings_lang.sqf", R3F_ARTY_AND_LOG_CFG_langage];
	...
	{
		execVM "z\addons\dayz_code\R3F_ARTY_AND_LOG\surveiller_nouveaux_objets.sqf";
	}
	// Version allégée pour le serveur dédié
	else
	{
		execVM "z\addons\dayz_code\R3F_ARTY_AND_LOG\surveiller_nouveaux_objets_dedie.sqf";
	};
};