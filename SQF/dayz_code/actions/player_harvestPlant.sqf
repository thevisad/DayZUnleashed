...
_trees = ["pumpkin.p3d","p_helianthus.p3d","p_fiberplant_ep1.p3d","t_purus2s.p3d","t_malus1s.p3d","b_corylus.p3d","b_corylus2s.p3d","b_sambucus.p3d","b_prunus.p3d","p_urtica.p3d","p_carduus.p3d","b_canina2s.p3d","p_papaver_EP1.p3d"];
_treesOutput = ["FoodPumpkin","FoodSunFlowerSeed","ItemKiloHemp","ItemPear","ItemApple","ItemHazelnut","ItemHazelnut","ItemElderberry","ItemCherry","ItemNettle","ItemThistle","ItemRose","ItemPoppy"];
