...
if (_hasrequireditem) then {
	...
	if (isClass (configFile >> "SnapPoints" >> _classname)) then {
		s_building_snapping = player addAction ["<t color=""#0000ff"">Toggle Snapping</t>", "\z\addons\dayz_code\actions\DZE\player_toggleSnapping.sqf",_classname, 3, true, false, "",""];
	};
