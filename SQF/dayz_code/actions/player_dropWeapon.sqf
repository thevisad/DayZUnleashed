...
if ((dayz_onBack != "") && (dayz_onBack in MeleeWeapons) && carryClick) then {
	switch DayZ_onBack do {
		...
		case "MeleeBaseBallBat": {_item = "ItemBaseBallBat"; dayz_onBack = "";};
		case "MeleeBaseBallBatBarbed": {_item = "ItemBaseBallBatBarbed"; dayz_onBack = "";};
		case "MeleeBaseBallBatBarbed": {_item = "ItemBaseBallBatNails"; dayz_onBack = "";};
