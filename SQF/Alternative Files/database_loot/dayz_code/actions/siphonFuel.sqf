...
if(DZE_ActionInProgress) exitWith { cutText ["Siphon already in progress." , "PLAIN DOWN"] };
...
_availableCansEmpty = ["ItemFuelcanEmpty","ItemJerrycanEmpty","ItemFuelBarrelEmpty"];
