...
if (!isDedicated) then
{
	[] spawn
	{
		while {true} do
		{
			if (!isNil "dayzLogin") then {dayzLogin 	= nil;};
			if (!isNil "dayzLogin2") then {dayzLogin2 	= nil;};
			sleep 0.5;
		};
	};
}
